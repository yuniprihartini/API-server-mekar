...
CREATE TABLE `pekerjaan` (
  ...
  PRIMARY KEY (`id_pekerjaan`,`nama_pekerjaan`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pendidikan` (
  ...
  `jenjang_pendidikan` varchar(36) NOT NULL,
...
CREATE TABLE `user` (
  ...
  `id_pekerjaan` varchar(45) NOT NULL,
  ...
  KEY `fk_pekerjaan_idx` (`id_pekerjaan`),
  KEY `fk_pendidikan_idx` (`id_pendidikan`),
  CONSTRAINT `fk_pekerjaan` FOREIGN KEY (`id_pekerjaan`) REFERENCES `pekerjaan` (`id_pekerjaan`),
  CONSTRAINT `fk_pendidikan` FOREIGN KEY (`id_pendidikan`) REFERENCES `pendidikan` (`id_pendidikan`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-02-28 16:01:32
